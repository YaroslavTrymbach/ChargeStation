...
const char* CONFIG_KEY_STR_METER_VALUES_SAMPLE_INTERVAL           = "";
const char* CONFIG_KEY_STR_MINIMUM_STATUS_DURATION                = "";
...
const char* CONFIG_KEY_STR_STOP_TXN_ALIGNED_DATA                  = "";
const char* CONFIG_KEY_STR_STOP_TXN_ALIGNED_DATA_MAX_LENGTH       = "";
const char* CONFIG_KEY_STR_STOP_TXN_SAMPLED_DATA                  = "";
const char* CONFIG_KEY_STR_STOP_TXN_SAMPLED_DATA_MAX_LENGTH       = "";
const char* CONFIG_KEY_STR_SUPPORTED_FEATURE_PROFILES             = "";
const char* CONFIG_KEY_STR_SUPPORTED_FEATURE_PROFILES_MAX_LENGTH  = "";
const char* CONFIG_KEY_STR_TRANSACTION_MESSAGE_ATTEMPTS           = "";
const char* CONFIG_KEY_STR_TRANSACTION_MESSAGE_RETRY_INTERVAL     = "";
const char* CONFIG_KEY_STR_UNLOCK_CONNECTOR_ON_EV_SIDE_DISCONNECT = "";
const char* CONFIG_KEY_STR_WEB_SOCKET_PING_INTERVAL               = "";

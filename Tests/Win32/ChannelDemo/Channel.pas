...
type
  ...
  private
    FMainWnd: Cardinal; //ќкно в которое будут посылатьс€ оповешени€ о приходе новых сообщений
    FNotifyMessage: Cardinal; // Id сообщени€, которое будет отсылатьс€
